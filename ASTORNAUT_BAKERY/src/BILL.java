...
if(p==0)
{
        ...
        Object[] row = {"","","","HARGA",Amount};
        Object[] row1 = {"","","","PAJAK(5%)",tax};
        Object[] row2 = {"","","","TOTAL",total};
        
 DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.addRow(row);model.addRow(row1);model.addRow(row2);
            MessageFormat Header = new MessageFormat("ASTORNAUT BAKERY");
            MessageFormat Footer = new MessageFormat("Enjoy The Sweetnes From Astornaut Bakery");
 try
{
